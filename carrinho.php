<?php
    ...
    $sql = mysql_query($con, "SELECT * FROM pedido;");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <br><br>
        ...
        <table class="form-control bg-primary table table-hover"> 
            ...
            <tr>
                ...
                <td><a href="pedidos.php?id<?=$dados["id"]?>">COMPRAR</a></td>
                <td><a href="cancela.php?id<?=$dados["id"]?>">CANCELAR</a></td>
